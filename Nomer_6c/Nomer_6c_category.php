...
if(isset($_POST['Submit1'])) {
  ...
  $result1 = mysqli_query($conn,"INSERT INTO category (Nama)VALUES ('$Name')");
                ...
                <table class="table rounded shadow">
                    ...
                    <tbody>      
                        <tr>    
                         ...
                         <td><button type="button" class="btn btn-success editbtn">EDIT</button>|<button type="button" class="btn btn-success deletebtn">DELETE</button>
                         </td>
                        </tr>
                    </tbody> 
                    <?php
...
<footer>
<button class="btn btn-success editbtn" onclick="window.location.href='Nomer_6c.php'">Home</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="Nomer_6c_category.php" method="post">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="edit13.php" method="POST">
        <div class="form-group">
        <label for="name" class="col-form-label">No Yang di Edit:</label>
            <input type="text" class="form-control" name="updateid" id="update_id">
                 ...
                 <label for="name" class="col-form-label">Jenis Makanan:</label>
            <input type="text" class="form-control" name="nama" id="nama">
          </div>
      </div>
      <div class="modal-footer">
        <button type="submit" name="Updatedata1" class="btn btn-primary">Update Data</button>
        </form>
      </div>
    </div>
  </div>
...
<!-- ##################################################################################################### -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" name="Deletedata1" class="btn btn-primary">Delete Data</button>
