...
if(isset($_POST['Submit2'])) {
  ...
  $result1 = mysqli_query($conn,"INSERT INTO cashier (Nama)VALUES ('$Name')");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="Nomer_6c_cashier.php" method="post">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="edit14.php" method="POST">
        <div class="form-group">
        <label for="name" class="col-form-label">No Yang di Edit:</label>
            <input type="text" class="form-control" name="updateid" id="update_id">
                 ...
                 <label for="name" class="col-form-label">Nama Cashier:</label>
            <input type="text" class="form-control" name="nama" id="nama">
          </div>
      </div>
      <div class="modal-footer">
        <button type="submit" name="Updatedata2" class="btn btn-primary">Update Data</button>
        </form>
      </div>
    </div>
  </div>
...
<!-- ##################################################################################################### -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" name="Deletedata2" class="btn btn-primary">Delete Data</button>
